    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-primary">Admin Permissions</h1>
        ...
        <Card className="bg-white border-primary/20">
          <CardHeader>
            <CardTitle className="text-primary">Super Admins</CardTitle>
                ...
                <TableBody>
                  {superAdmins.map((admin) => (
                    <TableRow key={admin.id}>
                      ...
                      <TableCell>
                        <Badge className="bg-primary text-white">Super Admin</Badge>
                      </TableCell>
                      <TableCell>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="text-primary font-semibold">Name</TableHead>
                    <TableHead className="text-primary font-semibold">Email</TableHead>
                    <TableHead className="text-primary font-semibold">Permissions</TableHead>
          ...
          <DialogContent className="max-w-2xl bg-white border-primary/20">
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 rounded-md border border-primary/20">
                  <div className="space-y-0.5">
                    <Label htmlFor="canManageCourses" className="text-primary font-medium">
                      Manage Courses
                    </Label>
                ...
                <div className="flex items-center justify-between p-3 rounded-md border border-primary/20">
                  <div className="space-y-0.5">
                    <Label htmlFor="canManageMembers" className="text-primary font-medium">
                      Manage Members
                    </Label>
                ...
                <div className="flex items-center justify-between p-3 rounded-md border border-primary/20">
                  <div className="space-y-0.5">
                    <Label htmlFor="canManageSettings" className="text-primary font-medium">
                      Manage Settings
                    </Label>
                ...
                <div className="flex items-center justify-between p-3 rounded-md border border-primary/20">
                  <div className="space-y-0.5">
                    <Label htmlFor="canManageDepartments" className="text-primary font-medium">
                      Manage Departments
                    </Label>
                ...
                <div className="flex items-center justify-between p-3 rounded-md border border-primary/20">
                  <div className="space-y-0.5">
                    <Label htmlFor="canManageLevels" className="text-primary font-medium">
                      Manage Levels
                    </Label>
                ...
                <div className="flex items-center justify-between p-3 rounded-md border border-primary/20">
                  <div className="space-y-0.5">
                    <Label htmlFor="canViewAnalytics" className="text-primary font-medium">
                      View Analytics
                    </Label>
                ...
                <div className="flex items-center justify-between p-3 rounded-md border border-primary/20">
                  <div className="space-y-0.5">
                    <Label htmlFor="canManageGroups" className="text-primary font-medium">
                      Manage Groups
                    </Label>
